...
@objc public protocol DevMenuDelegateProtocol {
   ...
   */
  @objc optional func appBridge(forDevMenuManager manager: DevMenuManager) -> RCTBridge?
   ...
   */
  @objc optional func shouldShowOnboarding(manager: DevMenuManager) -> Bool

  /**
   Tells the manager which user interface style to use.
   */
  @available(iOS 12.0, *)
  @objc optional func userInterfaceStyle(forDevMenuManager manager: DevMenuManager) -> UIUserInterfaceStyle
}
