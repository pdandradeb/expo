...
const { set, cond, onChange, block, eq, greaterOrEq, 
// sqrt,
not, defined, max, add, and, Value, spring, or, divide, greaterThan, sub, 
// event,
    ...
    class BottomSheetBehavior extends React.Component {
        constructor(props) {
            ...
            this.translateMaster = block([
                ...
                cond(greaterThan(masterOffseted, snapPoints[0]), cond(and(props.enabledBottomClamp ? 1 : 0, greaterThan(masterOffseted, this.clampingValue)), this.clampingValue, masterOffseted), max(0, masterOffseted)),
            ]);
        ...
        render() {
            return (React.createElement(React.Fragment, null,
                ...
                React.createElement(Animated.View, { style: {
                    ...
                    React.createElement(View, { style: [styles.container, { height: this.state.initSnap }] },
